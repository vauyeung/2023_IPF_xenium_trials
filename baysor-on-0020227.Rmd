...
```{bash, eval=F}
~/.julia/bin/baysor run -x x_location -y y_location -z z_location -g feature_name -p -m 20 -s 7 --save-polygons=geojson -o ./output-XETG00143__0020227__Region_1__20231214__022306/baysor_nopriors ./output-XETG00143__0020227__Region_1__20231214__022306/X0.0-24000.0_Y0.0-24000.0_filtered_transcripts.csv

```
Run 10X post-processing on this to convert back to a cells-by-count matrix. Current version of baysor produces this also, but whatever, let's follow a standard procedure for now.
```{bash}
./map_transcripts.py -baysor ./output-XETG00143__0020227__Region_1__20231214__022306/baysor_nopriors/segmentation.csv -out baysor_nopriors
```
...
```{bash, eval=F}
~/.julia/bin/baysor run -x x_location -y y_location -z z_location -g feature_name -m 20 -p --prior-segmentation-confidence 0.5 --save-polygons=geojson -o ./output-XETG00143__0020227__Region_1__20231214__022306/baysor_withpriors ./output-XETG00143__0020227__Region_1__20231214__022306/X0.0-24000.0_Y0.0-24000.0_filtered_transcripts.cellINT.csv :cell_id_int
```
Run 10X post-processing on this to convert back to a cells-by-count matrix. Current version of baysor produces this also, but whatever, let's follow a standard procedure for now. 
```{bash}
./map_transcripts.py -baysor ./output-XETG00143__0020227__Region_1__20231214__022306/baysor_withpriors/segmentation.csv -out baysor_withpriors
```
